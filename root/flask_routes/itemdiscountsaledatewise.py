...
@app_file33.route("/itemdatewisediscountedsales", methods=["POST"]) #this gives sales with discounts for passed item
@cross_origin()
def stats():
    try:
        ...
        query = '''select b.date, sum(a.count) , b.Outlet_Name, b.`Type`, b.Discounts , b.DiscountAmt  from tblorder_detailshistory a, tblorderhistory b where a.order_ID = b.idtblorderHistory and b.date between %s and %s and a.ItemName = %s and b.Discounts != "None" group by b.date,  b.Outlet_Name, b.Discounts order by b.Outlet_Name, b.date'''
